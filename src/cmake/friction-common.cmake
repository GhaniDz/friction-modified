...
if(WIN32)
    ...
    if(UNIX AND NOT APPLE)
        ...
        set(GPERF_INCLUDE_DIRS ${CMAKE_CURRENT_BINARY_DIR}/../gperftools /usr/include ${UNWIND_INCLUDE_DIRS})
        set(GPERF_LIBRARIES_DIRS ${CMAKE_CURRENT_BINARY_DIR}/../gperftools /usr/lib/x86_64-linux-gnu)
        set(GPERF_LIBRARIES tcmalloc ${UNWIND_LIBRARIES})
    endif()
    if(${BUILD_SKIA})
