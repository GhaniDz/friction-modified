...
protected:
    ...
    bool mTimelineCollapseVisible = false;

    void updatePathCompositionBoxVisible();
    void updateCompositionBoxVisible();
    void updateFillTypeBoxVisible();
    void updateTimelineRelationCombosVisible();
    void updatePickWhipButtonsVisible();

    void clearAndHideValueAnimators();
    void updateValueSlidersForQPointFAnimator();
    void updateCombinedPointValue();
    void syncTimelineRelationControls();
    void refreshParentLayerCombo(BoundingBox *box);
    bool isTimelineLayerRow() const;
    QRect timelineColorSwatchRect(int nameX) const;
    void editTimelineColor(BoundingBox *box);
private:
    void refreshDisplayName();
    void beginInlineExpressionEdit();
    void applyInlineExpressionEdit();
    ...
    bool mInlineExpressionEditing = false;
