...
public:
    ...
    bool toggleSnapshotView();
    bool hasSnapshot() const { return !mSnapshotImage.isNull(); }
    bool snapshotVisible() const { return mShowSnapshot; }
    void startCropSelectionMode();
    void cancelCropSelectionMode();
    bool cropModeActive() const { return mCropMode; }
...
private:
    ...
    void exitSnapshotView();
    void setCropMode(bool active);
    bool applyCropRect(const QRectF &windowRect);
    ...
    QImage mSnapshotImage;
    bool mShowSnapshot = false;
    bool mSnapshotHoldActive = false;
    bool mCropMode = false;
    bool mCropSelecting = false;
    QPointF mCropStartWindowPos;
    QRectF mCropSelectionWindowRect;
...
signals:
    ...
    void snapshotStateChanged(bool hasSnapshot, bool showingSnapshot);
