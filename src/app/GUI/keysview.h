...
private:
    ...
    void releaseMouseAndDontTrack() {
        ...
        mMovingKeys = false;
        mScalingKeys = false;
        mEdgeScalingKeys = false;
        mMovingRect = false;
        mSelecting = false;
        mEdgeScalePivotAbsFrame = 0;
        mEdgeScaleStartAbsFrame = 0;
    ...
    bool mEdgeScalingKeys = false;
    bool mMovingRect = false;
    bool mMoveAllSelected = false;
    bool mPressedCtrlPoint = false;
    int mEdgeScalePivotAbsFrame = 0;
    int mEdgeScaleStartAbsFrame = 0;
