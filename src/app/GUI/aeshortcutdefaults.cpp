...
QList<AeShortcutDefinition> aeShortcutDefinitions()
{
    return {
        ...
        {QStringLiteral("aeCenterPivot"), QStringLiteral("Transform"), QObject::tr("Align to Composition Center"), QObject::tr("Align selected layer(s) horizontally and vertically to the composition center."), QStringLiteral("Ctrl+Home")},
        {QStringLiteral("aeAlignCenter"), QStringLiteral("Transform"), QObject::tr("Center Pivot"), QObject::tr("Move the anchor / pivot of the selected layer(s) to the visual center."), QStringLiteral("Ctrl+Alt+Home")},
