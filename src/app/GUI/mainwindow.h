...
public:
    ...
    void activateSceneWorkspace(Canvas *scene);
...
private:
    ...
    AeShortcutController *mAeShortcutController = nullptr;
    ...
    Friction::Ui::AlignWidget *mAlignWidget = nullptr;
    ...
    QWidget *createEffectsPresetsPanel();
    void syncPanelsMenuState();
    void updateWorkspaceTabTitles();
    void ensureBottomSceneTab(Canvas *scene);
    void attachTimelineToBottomScene(Canvas *scene);
    void selectBottomSceneTab(Canvas *scene);
    void closeBottomSceneTab(int index);
    void updateSceneNavigationChain(Canvas *scene);
    void openCurrentTextEditorPopup();
    ...
    QAction *mPanelCompositionAct = nullptr;
    QAction *mPanelProjectAct = nullptr;
