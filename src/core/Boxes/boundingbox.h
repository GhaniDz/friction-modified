...
public:
    ...
    { return mBlendMode; }
    QColor getTimelineColor() const { return mTimelineColor; }
    bool hasTimelineColor() const { return mTimelineColor.isValid(); }
    QColor defaultTimelineColor() const;
    QColor effectiveTimelineColor() const;
...
public:
    ...
    void clearParent();
    void clearParentKeepTransform();
    void setParentTransform(BasicTransformAnimator *parent);
    void setParentTransformKeepTransform(BasicTransformAnimator *parent);
    BasicTransformAnimator *getParentTransform() const { return mParentTransform; }
    ...
    bool hasRasterEffects() const;
    QList<stdsptr<RasterEffectCaller>> rasterEffectCallers(
...
//    int prp_getParentFrameShift() const;
    ...
    ContainerBox* getFirstParentLayerOrSelf() const;
