...
public:
    ...
    QList<BoundingBox*> selectedBoxesList() const;
    bool moveSelectedLayerInPointToFrame(int absFrame);
    bool moveSelectedLayerOutPointToFrame(int absFrame);
    bool trimSelectedLayersBeforeFrame(int absFrame);
    bool trimSelectedLayersAfterFrame(int absFrame);

    void ungroupSelectedBoxes();
    BoundingBox *precomposeSelectedBoxes();
